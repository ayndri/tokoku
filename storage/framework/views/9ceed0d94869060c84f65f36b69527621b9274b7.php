            ...
            <form action="">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <label for="employeeUrl" class="form-label">Slug</label>
                            <input type="url" class="form-control" id="employeeUrl">
                        </div>
                        <div class="mb-3">
                            <label for="StartleaveDate" class="form-label">Description</label>
                            <textarea class="form-control" id="VertimeassageInput" rows="3"></textarea>
                        </div>
                    ...
                    <div id="customerList">
                        <div class="row g-4 mb-3">
                            <div class="col-sm-auto">
                                <div>
                                    <h4 class="card-title mb-0">List Attributes</h4>
                                </div>
                            </div>
                            <div class="col-sm">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tokoku\resources\views/products/attributes.blade.php ENDPATH**/ ?>