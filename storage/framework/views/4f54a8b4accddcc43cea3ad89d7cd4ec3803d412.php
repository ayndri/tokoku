                    ...
                    <h2 class="accordion-header" id="flush-headingBrands">
                        <button class="accordion-button bg-transparent shadow-none" type="button"
                            ...
                            <span class="text-muted text-uppercase fs-12 fw-medium">Brands</span> <span
                                class="badge bg-info rounded-pill align-middle ms-1">2</span>
                        </button>
                    </h2>
                    ...
                    <h2 class="accordion-header" id="flush-headingDiscount">
                        <button class="accordion-button bg-transparent shadow-none collapsed" type="button"
                            ...
                            <span class="text-muted text-uppercase fs-12 fw-medium">Discount</span> <span
                                class="badge bg-info rounded-pill align-middle ms-1">1</span>
                        </button>
                    </h2>
                ...
                <div class="card-header border-0">
                    <div class="row g-4">
                        <div class="col-sm-auto">
                            <div>
                                <a href="<?php echo e(route('addProduct')); ?>" class="btn btn-info"><i
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tokoku\resources\views/apps-ecommerce-products.blade.php ENDPATH**/ ?>