    ...
    <div class="col-lg-8">
        <form>
            <div class="card">
                <div class="card-body">
                    <div class="mb-3">
                        <label class="form-label" for="nama-produk-input">Nama Produk</label>
                        <input type="text" name="namaProduk" class="form-control" id="nama-produk-input"
                            placeholder="Masukkan nama produk">
                    </div>
                    <div>
                        <label>Deskripsi Produk</label>
                        
                        <div name="deskProduk" id="ckeditor-classic">
                            <textarea name="deskProduk"></textarea>
                        </div>
                    </div>
                </div>
            </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="mb-3">
                                                <label class="form-label"
                                                    for="product-discount-input">Sale</label>
                                                <div class="input-group mb-3">
                                                    <span class="input-group-text"
                                                        id="product-discount-addon">Rp</span>
    ...
    <div class="col-lg-4">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                data-choices  data-choices-search-false data-choices-sorting="true">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">Produk Tags</h5>
            </div>
            <div class="card-body">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tokoku\resources\views/products/add-product.blade.php ENDPATH**/ ?>